<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- NEW: INTEGRATED HEADER (Inside the content) -->
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        @if($game->notes)
                            <div class="mt-4 pt-4 border-t border-gray-700">
                                ...
                                <div class="text-gray-300 text-sm whitespace-pre-wrap bg-gray-900/50 p-3 rounded border border-gray-700/50">
                                    {{ $game->notes }}
                                </div>
                            </div>
                        @endif
                        ...
                        <form action="{{ route('games.tasks.store', $game) }}" method="POST">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="name" required placeholder="e.g. Spiral Abyss, Monthly Shop" 
                                        class="w-full rounded-md border-gray-600 bg-gray-700 text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div x-show="taskType === 'loop'" class="p-3 bg-indigo-900/30 border border-indigo-500/50 rounded-md">
                                    ...
                                    <div class="flex gap-2 items-center">
                                        <input type="number" name="repeat_days" min="1" placeholder="e.g. 14"
                                            class="w-24 rounded-md border-gray-600 bg-gray-700 text-white shadow-sm">
                                        <span class="text-xs text-gray-400">
                                            (e.g. Enter <strong>14</strong> for Abyss)
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-3 mb-4">
                                @foreach($game->events as $event)
                                    <div class="bg-green-900/20 border border-green-800 p-3 rounded text-sm relative group">
                                        ...
                                        <div class="text-xs text-gray-400">{{ $event->end_time->diffForHumans() }}</div>
                                    </div>
                                @endforeach
                            </div>
